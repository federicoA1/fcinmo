...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->linksT['Agregar una foto'] = "$filename?act=am";
    ...
    case "a":   
                ...
                if($_FILES[imagen]){
                    Utiles::miniaturaR(400,615,$_FILES[imagen][tmp_name],"../galeria/",$idArticulo.".jpg");
                } 
                echo User::wrapper($_SESSION[listado]->listar(),"Admin Links") ; 
             break;
    case "m":   
               $_SESSION[listado]->modi(array_merge($_POST,$_FILES));
               $idArticulo = $_REQUEST[$_SESSION[listado]->pk];
               if($_FILES[imagen]){
                    Utiles::miniaturaR(400,615,$_FILES[imagen][tmp_name],"../galeria/",$idArticulo.".jpg");
                } 
               echo User::wrapper( $_SESSION[listado]->listar(),"Admin Links") ;       
