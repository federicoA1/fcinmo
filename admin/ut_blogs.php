...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->linksT['Agregar una nuevo Blog'] = "$filename?act=am";
        ...
        $listado->botones[0] ='<a href="'.$filename.'?tabla=' . $listado->tabla . '&'.$listado->pk.'={id}&pk=' . $listado->pk . '&act=d" onclick="return confirm(\'Esta seguro?\');"><img src="images/es/btn_eliminar.png" alt="Eliminar"  border="0" ></a>
          ...
          &nbsp;&nbsp;'; 
          $listado->botones[2] ='<a href="ut_blogs_posts.php?act=I&parent_campo=id_blog&parent_valor={id}"><img src="images/es/btn_agregarPosts.png" alt="Modificar"  border="0" ></a>
          &nbsp;&nbsp;';
