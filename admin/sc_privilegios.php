...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->tabla     = "sc_privilegios";
        $listado->linksT['Agregar un nuevo Privilegio'] = "$filename?act=am";

        $listado->pk = "id_privilegio";
        ...
        $listado->botones[0] ='<a href="'.$filename.'?tabla=' . $listado->tabla . '&'.$listado->pk.'={id}&pk=' . $listado->pk . '&act=d"><img src="images/btn_eliminar.png" alt="Delete"  border="0" ></a>
          &nbsp;&nbsp;';
        //$listado->buscador['campos'] =array("email");
        
        $listado->fk["id_seccion"] = array("sc_secciones","nombre","id");
        $listado->fk["id_usuario"] = array("sc_usuarios","username","id");
        ...
        $_SESSION[listado]=$listado;
         ...
         echo Main::wrapper($listado->listar(),"Admin Links") ; 
