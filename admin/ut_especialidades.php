...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->tabla     = "especialidades";
        $listado->linksT['Volver']   = "index.php"; 
        $listado->linksT['Agregar una nueva Especialidad'] = "$filename?act=am";
        ...
        $listado->inplace = array(  "header"=>"simple_text",
                                    ...
                                    "col2"=>"simple_text",
                                    "col3"=>"simple_text");
        $listado->noshow = array("texto1"=>1,"texto2"=>1,"clean_name"=>1,"doctores"=>1,"meta_key"=>1,"meta_desc"=>1);
