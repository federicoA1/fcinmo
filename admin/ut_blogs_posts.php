...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->tabla     = "blogs_posts";
        $listado->linksT['Volver']   = "index.php"; 
        $listado->linksT['Agregar una nuevo Post'] = "$filename?act=am";

        $listado->pk = "id";
        $listado->sqlcore = "SELECT * from $listado->tabla where $_REQUEST[parent_campo] = '$_REQUEST[parent_valor]' ";
        ...
        $listado->fk["id_blog"] = array("blogs","doctor","id");
        $listado->truefalse[mostrar] = 1;
