...
switch($_REQUEST[act]){
    ...
    case "I":
        ...
        $listado->tabla     = "paginas";
        $listado->linksT['Volver']   = "index.php"; 
       // $listado->linksT['Agregar una nueva'] = "$filename?act=am";
        ...
        $listado->inplace = array(  "header"=>"simple_text",
                                    ...
                                    "col2"=>"simple_text",
                                    "col3"=>"simple_text");
        $listado->noshow = array("contenido"=>1,"texto2"=>1,"clean_name"=>1,"doctores"=>1,"meta"=>1,"meta_desc"=>1);
        

       
          $listado->botones[0] ='<a href="'.$filename.'?tabla=' . $listado->tabla . '&'.$listado->pk.'={id}&pk=' . $listado->pk . '&act=am"><img src="images/es/btn_editar.png" alt="Modificar"  border="0" ></a>
          &nbsp;&nbsp;';
